...
class SSH_Handler():
    def generate_SSH_Key(self, ssh_dir=r".\.ssh") -> None:
    ...
    def copy_SSH_key(self, pub_key_file=r".\.ssh\id_rsa.pub", username="ivo", ip="192.168.112.104") -> None:
    ...
    def fix_windows_key_permissions(self, ssh_file=r".\.ssh\id_rsa") -> None:
        """
    ...
    def test_SSH_without_password(self, ssh_file=r".\.ssh\id_rsa", username="ivo", ip="192.168.112.104") -> bool:
